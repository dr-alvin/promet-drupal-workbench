...
module.exports=function make(config,scenarios,mode,work='/work') {
  ...
  return {
    ...
    asyncCaptureLimit:Number(process.env.AUDIT_ASYNC_CAPTURE_LIMIT||1),asyncCompareLimit:Number(process.env.AUDIT_ASYNC_COMPARE_LIMIT||4),debug:false,debugWindow:false,
